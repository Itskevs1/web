...
import "./hasstyle/Budgetmealss.css"; // Assuming this is the correct CSS
import { assets } from "../assets/assets";
import { useCart } from '../CartandOrder/userCart.js'; // ADDED
import { toast } from 'react-toastify';                 // ADDED
import 'react-toastify/dist/ReactToastify.css';      // ADDED

// Data (SETA_80, SETS_150 already have 'id' properties which is good)
const SETS_80 = [
  {
    id: "A",
...
const Budgetmealss = () => {
  ...
  // UPDATED handler for budget meal sets
  ...
  return (
    <div className="budget-container">
      ...
      <div className="sets-grid">
        {currentSets.map((set) => ( // Using currentSets
