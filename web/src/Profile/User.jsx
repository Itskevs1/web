...
const User = () => {
  ...
  const [profileImageUrl, setProfileImageUrl] = useState(assets.user || assets.personal);
  const [currentEmail, setCurrentEmail] = useState('geselranan@gmail.com'); // Email might also be editable

  const initialProfileDetails = {
    name: 'Gesel E. Ranan',
    age: '30',
    contactNumber: '09262003001',
    // idNumber: '2023306565', // Kept for potential future use
    // birthdate: 'December 25, 2025', // Kept for potential future use
  };
  ...
  const [editableProfileDetails, setEditableProfileDetails] = useState(initialProfileDetails);
  const [editableEmail, setEditableEmail] = useState(currentEmail);


  const [isAddressEditing, setIsAddressEditing] = useState(false);
  const [address, setAddress] = useState('123 Main St, Springfield, CDO');
  ...
  const handleSavePassword = () => {
    ...
    console.log("Changing password. Current:", currentPassword, "New:", newPassword);
    setCurrentPassword('');
    setNewPassword('');
  ...
  return (
    <div className="user-profile-container">
      ...
      <div className="profile-section-row">
        ...
        <div className="profile-card">
          <div className="card-header">
            <img src={assets.personal} alt="Personal Details" className="card-icon" />
            ...
            <div className="details-list">
              ...
              <div className="detail-item">
                ...
                {showEditTrigger ? (
                  ...
                  <span className="detail-value">{profileDetails.contactNumber}</span>
                )}
              </div>
            </div>
          </div>
        ...
        <div className="profile-card">
          <div className="card-header">
            <img src={assets.history} alt="History Transaction" className="card-icon" />
      ...
      {/* Bottom Section */}
      <div className="profile-section-row bottom-row"> {/* Added class for specific styling if needed */}
        {/* Settings Card */}
        <div className="profile-card settings-card"> {/* Added class for specific styling if needed */}
          <div className="card-header">
          ...
          <div className="card-content">
            ...
            <button onClick={handleSavePassword} className="btn-primary save-password-btn" title="Save New Password">
              Save Password
            </button>
          </div>
        </div>
        ...
        <div className="profile-card address-card"> {/* Added class for specific styling if needed */}
          <div className="card-header">
            <img src={assets.location} alt="Saved Address" className="card-icon" />
      ...
      <div className="profile-footer">
        <button className="logout-btn btn-primary" onClick={handleOpenLogoutModal}>Log out</button>
      </div>
        ...
        <div className="modal-overlay" onClick={handleCloseLogoutModal}>
          <div className="modal" onClick={(e) => e.stopPropagation()}>
            <div className="modal-icon-container">
              <img src={assets.signlog || assets.default_modal_icon} alt="Logout confirmation" className="modal-icon" />
            </div>
            <p className="modal-text">Are you sure you want to log out?</p>
            <div className="modal-buttons">
              <button onClick={handleConfirmLogout} className="btn-primary modal-btn-logout">Log out</button>
              <button onClick={handleCloseLogoutModal} className="btn-outline modal-btn-stay">Stay logged in</button>
            </div>
          </div>
        </div>
      )}
